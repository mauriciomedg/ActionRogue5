 ...
 */
UCLASS()
class ACTIONROGUE5_API ASGameModeBase : public AGameModeBase
{
	GENERATED_BODY()
...
protected:
	...
	UFUNCTION()
	void OnQuerySpawnBotCompleted(UEnvQueryInstanceBlueprintWrapper* QueryInstance, EEnvQueryStatus::Type QueryStatus);
